(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterJson = {}, global.fs, global.path));
   ...
   * @public
   */
  const isObject = node => isNodeType('object', node);
  ...
  // isNode :: Node -> Boolean
  const isNode$2 = pipe(getNodeType$2, isString$1);
  ...
  class TreeCursorSyntaxNode {
    constructor(cursor) {
      ...
      __publicField$4(this, "startPositionRow");
      __publicField$4(this, "startPositionColumn");
      __publicField$4(this, "startIndex");
      __publicField$4(this, "endPositionRow");
      __publicField$4(this, "endPositionColumn");
      __publicField$4(this, "endIndex");
      __publicField$4(this, "text");
      __publicField$4(this, "isNamed");
      __publicField$4(this, "isMissing");
      __publicField$4(this, "fieldName");
      __publicField$4(this, "hasError", false);
      __publicField$4(this, "children", []);
  ...
  let CstVisitor$1 = class CstVisitor {
    constructor() {
      __publicField$3(this, "sourceMap", false);
      __publicField$3(this, "annotations");
      __publicField$3(this, "ParseResultElement", {
        leave: (element) => {
  ...
  const keyMap$2 = __spreadValues$1({
    document: ["children"],
    object: ["children"],
    array: ["children"],
    string: ["children"],
  ...
  class CstVisitor {
    constructor() {
      __publicField$1(this, "document", {
        ...
        leave: (document) => {
          return new ParseResult$1({ children: [document] });
        }
      });
    }
    enter(node) {
    ...
    number(node) {
      ...
      return new JsonNumber(
        assignSourceMap({ value, isMissing: node.isMissing }, node)
      );
    }
    // eslint-disable-next-line @typescript-eslint/naming-convention
    null(node) {
  ...
  class JsonAstVisitor {
    constructor() {
      __publicField(this, "sourceMap", false);
      __publicField(this, "annotations");
      __publicField(this, "ParseResultElement", {
        leave: (element) => {
          const elements = element.findElements(isPrimitiveElement);
          if (elements.length > 0) {
            const resultElement = elements[0];
  ...
  const analyze = (cst, { sourceMap = false } = {}) => {
    ...
    const jsonAst = visit$1(rootNode, cstVisitor, {
      // @ts-ignore
      keyMap: keyMap$1,
      state: {
        sourceMap
    ...
    return visit$1(jsonAst.rootNode, astVisitor, {
      // @ts-ignore
      keyMap: keyMap,
  ...
  class JSONMediaTypes extends MediaTypes {
    latest() {
      return this[0];
    }
  }
  ...
  const detectionRegExp = (
    ...
    new RegExp('(?<true>^\\s*true\\s*$)|(?<false>^\\s*false\\s*$)|(?<null>^\\s*null\\s*$)|(?<number>^\\s*\\d+\\s*$)|(?<object>^\\s*{\\s*)|(?<array>^\\s*\\[\\s*)|(?<string>^\\s*"(((?=\\\\)\\\\(["\\\\/bfnrt]|u[0-9a-fA-F]{4}))|[^"\\\\\\x00-\\x1F\\x7F])*"\\s*$)')
  );
  ...
  exports.lexicalAnalysis = analyze$2;
  exports.mediaTypes = mediaTypes;
  exports.namespace = namespace;
  exports.parse = parse;
  exports.syntacticAnalysis = analyze$1;
  exports.syntacticAnalysisDirect = analyze$1;
  exports.syntacticAnalysisIndirect = analyze;
