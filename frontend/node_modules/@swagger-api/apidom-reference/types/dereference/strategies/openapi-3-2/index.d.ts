 ...
 * @public
 */
export interface OpenAPI3_2DereferenceStrategyOptions extends Omit<DereferenceStrategyOptions, 'name'> {
}
/**
 * @public
 */
declare class OpenAPI3_2DereferenceStrategy extends DereferenceStrategy {
