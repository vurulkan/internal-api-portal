 ...
 * @public
 */
class OpenAPI3_2ResolveStrategy extends _ResolveStrategy.default {
  constructor(options) {
    super({
  ...
  canResolve(file, options) {
    const dereferenceStrategy = options.dereference.strategies.find(strategy => strategy.name === 'openapi-3-2');
  ...
  async resolve(file, options) {
    const dereferenceStrategy = options.dereference.strategies.find(strategy => strategy.name === 'openapi-3-2');
    if (dereferenceStrategy === undefined) {
      throw new _UnmatchedDereferenceStrategyError.default('"openapi-3-2" dereference strategy is not available.');
    }
...
var _default = exports.default = OpenAPI3_2ResolveStrategy;