...
const isWindows = () => {
  ...
  return /^win/.test((_globalThis$process$p = (_globalThis$process = globalThis.process) == null ? void 0 : _globalThis$process.platform) != null ? _globalThis$process$p : '');
};
...
const cwd = () => {
  ...
  const path = (_globalThis$process$c = (_globalThis$process2 = globalThis.process) == null ? void 0 : _globalThis$process2.cwd()) != null ? _globalThis$process$c : '/';
