...
var _apidomParserAdapterOpenapiYaml = require("@swagger-api/apidom-parser-adapter-openapi-yaml-3-2");
 ...
 * @public
 */
class OpenAPIYAML3_2Parser extends _Parser.default {
  syntacticAnalysis;
  refractorOpts;
  constructor(options) {
    const {
...
var _default = exports.default = OpenAPIYAML3_2Parser;