...
exports.OpenAPI3_2DereferenceVisitor = _visitor.default;
 ...
 * @public
 */
class OpenAPI3_2DereferenceStrategy extends _DereferenceStrategy.default {
  constructor(options) {
    super({
  ...
  canDereference(file) {
    ...
    return (0, _apidomNsOpenapi.isOpenApi3_2Element)((_file$parseResult = file.parseResult) == null ? void 0 : _file$parseResult.result);
  }
...
var _default = exports.default = OpenAPI3_2DereferenceStrategy;