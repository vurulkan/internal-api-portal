(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomNsJsonSchemaDraft6 = {}));
   ...
   * @public
   */
  const isNode$1 = node => typeof getNodeType$2(node) === 'string';
  ...
  // isNode :: Node -> Boolean
  const isNode = pipe(getNodeType$1, isString);
  ...
  class JSONSchemaDraft6MediaTypes extends MediaTypes {
   ...
   * @public
   */
  let JSONSchema$1 = class JSONSchema extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  let LinkDescription$1 = class LinkDescription extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const jsonSchemaDraft4 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft4', JSONSchema$1);
  ...
  const isJSONSchemaElement$1 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$1 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft4', element) && primitiveEq('object', element);
  });
   ...
   * @public
   */
  let JSONSchemaVisitor$1 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
    ...
    handleDialectIdentifier(objectElement) {
      ...
      } else if (isJSONSchemaElement$1(this.parent) && !isStringElement(objectElement.get('$schema'))) {
   ...
   * @public
   */
  let LinkDescriptionVisitor$1 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
    ...
    visitors: {
      ...
      document: {
        objects: {
          ...
          LinkDescription: {
            $visitor: LinkDescriptionVisitor$1,
            fixedFields: {
              href: {
                $ref: '#/visitors/value'
              },
  ...
  const jsonSchemaDraft6 = {
    namespace: (options) => {
      const { base } = options;
      base.register("jSONSchemaDraft6", JSONSchema);
      base.register("jSONReference", JSONReference);
      base.register("media", Media);
  ...
  const schema = {
    ...
    "json-schema-links": {
      "<*>": function asterisk4(...args) {
        return new LinkDescription(...args);
      }
    }
  };
  ...
  const plugin = () => () => ({
    visitor: {
      StringElement(element, key5, parent, path, ancestors) {
  ...
  const specification = pipe(
    ...
    assocPath(
      ...
      specification$1.visitors.value
    ),
    assocPath(
      ["visitors", "document", "objects", "JSONSchema", "fixedFields", "contains"],
      specification$1.visitors.JSONSchemaOrJSONReferenceVisitor
    ),
    assocPath(
  ...
  const isJSONSchemaElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof JSONSchema || hasBasicElementProps(element) && isElementType("JSONSchemaDraft6", element) && primitiveEq("object", element);
    }
  );
  ...
  const createToolbox = () => {
    ...
    const predicates = __spreadProps(__spreadValues$1({}, jsonSchemaDraft6Predicates), { isStringElement });
  ...
  exports.ItemsVisitor = ItemsVisitor;
  ...
  exports.LinkDescriptionElement = LinkDescription;
  exports.LinkDescriptionVisitor = LinkDescriptionVisitor;
  exports.MapVisitor = MapVisitor;
  exports.MediaElement = Media;
  exports.ParentSchemaAwareVisitor = ParentSchemaAwareVisitor;
  ...
  exports.default = jsonSchemaDraft6;
