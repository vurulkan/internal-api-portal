...
import { isSchemaElement, isDiscriminatorElement } from "../../predicates.mjs";
    ...
    visitor: {
      ...
      SchemaElement: {
        leave(schemaElement, key, parent, path, ancestors) {
          ...
          const mapping = (_get = schemaElement.discriminator.get('mapping')) !== null && _get !== void 0 ? _get : new ObjectElement();
