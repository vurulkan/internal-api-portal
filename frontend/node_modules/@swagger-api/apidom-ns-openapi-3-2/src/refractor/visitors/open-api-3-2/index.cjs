 ...
 */
// eslint-disable-next-line @typescript-eslint/naming-convention
class OpenApi3_2Visitor extends (0, _tsMixer.Mixin)(_apidomNsOpenapi.FixedFieldsVisitor, _apidomNsOpenapi.FallbackVisitor) {
  constructor(options) {
    super(options);
...
var _default = exports.default = OpenApi3_2Visitor;