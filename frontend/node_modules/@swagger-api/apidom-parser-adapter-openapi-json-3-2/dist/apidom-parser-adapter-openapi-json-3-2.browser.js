(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomParserAdapterOpenapiJson32 = {}, global.fs, global.path));
   ...
   * @public
   */
  const getNodeType$6 = node => node === null || node === void 0 ? void 0 : node.type;

  /**
   * @public
   */
  const isNode$3 = node => typeof getNodeType$6(node) === 'string';
  ...
  // isNode :: Node -> Boolean
  const isNode$2 = pipe(getNodeType$5, isString$1);
  ...
  ParseResult$1.refract = createRefractor$7(ParseResult$1);
   ...
   * @public
   */
  const mediaTypes = new OpenAPIMediaTypes('application/vnd.oai.openapi;version=3.2.0', 'application/vnd.oai.openapi+json;version=3.2.0', 'application/vnd.oai.openapi+yaml;version=3.2.0');
   ...
   * @public
   */
  class ComponentsPathItems extends minimExports.ObjectElement {
   ...
   * @public
   */
  class Webhooks extends minimExports.ObjectElement {
  ...
  } = specification$1.visitors.document.objects;
  ...
  const detectionRegExp = new RegExp('"openapi"\\s*:\\s*"(?<version_json>3\\.2\\.(?:[1-9]\\d*|0))"');
  ...
  const parse = (_0, ..._1) => __async(null, [_0, ..._1], function* (source, options = {}) {
    ...
    if (isNotUndefined(result)) {
      const openApiElement = OpenApi3_2.refract(result, refractorOpts);
