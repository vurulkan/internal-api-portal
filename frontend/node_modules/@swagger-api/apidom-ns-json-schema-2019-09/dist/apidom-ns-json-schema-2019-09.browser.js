(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomNsJsonSchema201909 = {}));
  ...
  class JSONSchema201909MediaTypes extends MediaTypes {
   ...
   * @public
   */
  let JSONSchema$3 = class JSONSchema extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  let LinkDescription$3 = class LinkDescription extends minimExports.ObjectElement {
    constructor(content, meta, attributes) {
      super(content, meta, attributes);
  ...
  const jsonSchemaDraft4 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft4', JSONSchema$3);
  ...
  const isJSONSchemaElement$3 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$3 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft4', element) && primitiveEq('object', element);
  });
   ...
   * @public
   */
  let JSONSchemaVisitor$3 = class JSONSchemaVisitor extends Mixin(FixedFieldsVisitor, ParentSchemaAwareVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
    ...
    handleDialectIdentifier(objectElement) {
      ...
      } else if (isJSONSchemaElement$3(this.parent) && !isStringElement(objectElement.get('$schema'))) {
   ...
   * @public
   */
  let LinkDescriptionVisitor$3 = class LinkDescriptionVisitor extends Mixin(FixedFieldsVisitor, FallbackVisitor) {
    constructor(options) {
      super(options);
    ...
    visitors: {
      ...
      document: {
        objects: {
          ...
          LinkDescription: {
            $visitor: LinkDescriptionVisitor$3,
            fixedFields: {
              href: {
                $ref: '#/visitors/value'
              },
  ...
  const jsonSchemaDraft6 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft6', JSONSchema$2);
      base.register('jSONReference', JSONReference);
      base.register('media', Media);
  ...
  const isJSONSchemaElement$2 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$2 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft6', element) && primitiveEq('object', element);
  });
  ...
  const jsonSchemaDraft7 = {
    namespace: options => {
      ...
      base.register('jSONSchemaDraft7', JSONSchema$1);
      base.register('jSONReference', JSONReference);
  ...
  const isJSONSchemaElement$1 = createPredicate(({
    ...
    return element => element instanceof JSONSchema$1 || hasBasicElementProps(element) && isElementType('JSONSchemaDraft7', element) && primitiveEq('object', element);
  });
  ...
  const jsonSchema201909 = {
    namespace: (options) => {
      const { base } = options;
      base.register("jSONSchema201909", JSONSchema);
  ...
  const isJSONSchemaElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof JSONSchema || hasBasicElementProps(element) && isElementType("JSONSchema201909", element) && primitiveEq("object", element);
    }
  );
  ...
  const createToolbox = () => {
    ...
    const predicates = __spreadProps(__spreadValues$1({}, jsonSchema201909Predicates), { isStringElement });
  ...
  exports.$defsVisitor = $defsVisitor;
  exports.$refVisitor = $refVisitor;
  exports.$vocabularyVisitor = $vocabularyVisitor;
  exports.AllOfVisitor = AllOfVisitor;
  exports.AlternatingVisitor = AlternatingVisitor;
  exports.AnyOfVisitor = AnyOfVisitor;
  exports.DependentRequiredVisitor = DependentRequiredVisitor;
  exports.DependentSchemasVisitor = DependentSchemasVisitor;
  ...
  exports.OneOfVisitor = OneOfVisitor;
  exports.ParentSchemaAwareVisitor = ParentSchemaAwareVisitor;
  exports.PatternPropertiesVisitor = PatternPropertiesVisitor;
  ...
  exports.default = jsonSchema201909;
