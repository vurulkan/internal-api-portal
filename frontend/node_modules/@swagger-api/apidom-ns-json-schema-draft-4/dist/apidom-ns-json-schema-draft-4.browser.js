(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomNsJsonSchemaDraft4 = {}));
  ...
  class JSONSchemaDraft4MediaTypes extends MediaTypes {
  ...
  class SpecificationVisitor extends Visitor {
    constructor(_a) {
      var _b = _a, { specObj } = _b, rest = __objRest$3(_b, ["specObj"]);
      super(__spreadValues$5({}, rest));
      __publicField$4(this, "specObj");
      __publicField$4(this, "passingOptionsNames", ["specObj", "parent"]);
    ...
    retrieveVisitorInstance(specPath, options = {}) {
      ...
      const visitorOpts = __spreadValues$5(__spreadValues$5({}, passingOpts), options);
  ...
  class FixedFieldsVisitor extends SpecificationVisitor {
    constructor(_a) {
      var _b = _a, { specPath, ignoredFields } = _b, rest = __objRest$2(_b, ["specPath", "ignoredFields"]);
  ...
  class JSONSchemaVisitor extends Mixin(
    ...
    handleDialectIdentifier(objectElement) {
      if (isUndefined(this.parent) && !isStringElement(objectElement.get("$schema"))) {
        ...
        const inheritedDialectIdentifier = defaultTo(
          serializer(this.parent.meta.get("inheritedDialectIdentifier")),
          serializer(this.parent.$schema)
        );
    ...
    handleSchemaIdentifier(objectElement, identifierKeyword = "id") {
      const ancestorsSchemaIdentifiers = this.parent !== void 0 ? cloneDeep(this.parent.getMetaProperty("ancestorsSchemaIdentifiers", [])) : new minimExports.ArrayElement();
  ...
  class PatternedFieldsVisitor extends SpecificationVisitor {
    constructor(_a) {
      ...
      __publicField$1(this, "specPath");
      __publicField$1(this, "ignoredFields");
      __publicField$1(this, "fieldPatternPredicate", F);
      this.specPath = specPath;
      this.ignoredFields = ignoredFields || [];
  ...
  class SchemaOrReferenceVisitor extends AlternatingVisitor {
    constructor(options) {
      ...
      this.alternator = [
        ...
        { predicate: T, specPath: ["document", "objects", "JSONSchema"] }
      ];
    }
  }
  ...
  const createToolbox = () => {
    ...
    const predicates = __spreadProps(__spreadValues$1({}, jsonSchemaDraft4Predicates), { isStringElement });
  ...
  exports.default = jsonSchemaDraft4;
