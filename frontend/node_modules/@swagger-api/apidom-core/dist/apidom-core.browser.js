(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apidomCore = {}));
   ...
   */
  var filter$1 = /*#__PURE__*/_curry2( /*#__PURE__*/_dispatchable(['fantasy-land/filter', 'filter'], _xfilter, function (pred, filterable) {
   ...
   */
  var reject$1 = /*#__PURE__*/_curry2(function reject(pred, filterable) {
  ...
  var isObjectConstructor = pipe(toString$2, equals(toString$2(Object)));
  ...
  const isElement = createPredicate(({ hasBasicElementProps, primitiveEq }) => {
    return (element) => element instanceof minimExports.Element || hasBasicElementProps(element) && primitiveEq(void 0, element);
  });
  const isStringElement = createPredicate(({ hasBasicElementProps, primitiveEq }) => {
    return (element) => element instanceof minimExports.StringElement || hasBasicElementProps(element) && primitiveEq("string", element);
  });
  const isNumberElement = createPredicate(({ hasBasicElementProps, primitiveEq }) => {
    return (element) => element instanceof minimExports.NumberElement || hasBasicElementProps(element) && primitiveEq("number", element);
  });
  const isNullElement = createPredicate(({ hasBasicElementProps, primitiveEq }) => {
    return (element) => element instanceof minimExports.NullElement || hasBasicElementProps(element) && primitiveEq("null", element);
  });
  const isBooleanElement = createPredicate(({ hasBasicElementProps, primitiveEq }) => {
  ...
  const isMemberElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof minimExports.MemberElement || hasBasicElementProps(element) && isElementType("member", element) && primitiveEq(void 0, element);
    }
  );
  const isLinkElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof minimExports.LinkElement || hasBasicElementProps(element) && isElementType("link", element) && primitiveEq(void 0, element);
    }
  );
  const isRefElement = createPredicate(
    ({ hasBasicElementProps, isElementType, primitiveEq }) => {
      return (element) => element instanceof minimExports.RefElement || hasBasicElementProps(element) && isElementType("ref", element) && primitiveEq(void 0, element);
    }
  );
  ...
  const createToolbox = () => {
    const predicates = __spreadValues$7({}, basePredicates);
    return { predicates, namespace: namespace };
  };
   ...
   * @public
   */
  const getNodeType$1 = node => node === null || node === void 0 ? void 0 : node.type;

  /**
   * @public
   */
  const isNode$1 = node => typeof getNodeType$1(node) === 'string';
  ...
  var __publicField$d = (obj, key, value) => __defNormalProp$i(obj, key + "" , value);
  ...
  const cloneDeep = (value, options = {}) => {
    ...
    const passThroughOptions = __spreadProps$1(__spreadValues$6({}, options), { visited });
  ...
  var __publicField$c = (obj, key, value) => __defNormalProp$g(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  const isNode = pipe(getNodeType, isString);
  ...
  class PredicateVisitor {
    constructor({
      ...
      __publicField$c(this, "result");
      __publicField$c(this, "predicate");
      __publicField$c(this, "returnOnTrue");
      __publicField$c(this, "returnOnFalse");
      this.result = [];
  ...
  const visit$1 = (root, visitor, _a = {}) => {
    var _b = _a, { keyMap = keyMapDefault$1 } = _b, rest = __objRest$2(_b, ["keyMap"]);
    return visit$2(root, visitor, __spreadValues$5({
      // @ts-ignore
      keyMap,
      // @ts-ignore
  ...
  visit$1[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")] = (_0, _1, ..._2) => __async$2(null, [
    _0,
    // @ts-ignore
    _1,
    ..._2
  ], function* (root, visitor, _c = {}) {
    var _d = _c, { keyMap = keyMapDefault$1 } = _d, rest = __objRest$2(_d, ["keyMap"]);
    return visit$2[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")](root, visitor, __spreadValues$5({
      // @ts-ignore
      keyMap,
      // @ts-ignore
      nodeTypeGetter: getNodeType,
  ...
  const dispatchPluginsSync = ((element, plugins, options = {}) => {
    ...
    const mergedPluginsVisitor = mergeAll(pluginsSpecs.map(propOr({}, "visitor")), __spreadValues$4({}, visitorOptions));
  ...
  const dispatchPluginsAsync = (_0, _1, ..._2) => __async$1(null, [_0, _1, ..._2], function* (element, plugins, options = {}) {
    if (plugins.length === 0) return element;
    const mergedOptions = mergeDeepRight(
      defaultDispatchPluginsOptions,
      options
    ...
    const toolbox = toolboxCreator();
    const pluginsSpecs = plugins.map((plugin) => plugin(toolbox));
    const mergeAllVisitorsAsync = mergeAll[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")];
    const visitAsync = visit$1[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")];
    const mergedPluginsVisitor = mergeAllVisitorsAsync(pluginsSpecs.map(propOr({}, "visitor")), __spreadValues$4({}, visitorOptions));
    yield Promise.allSettled(pluginsSpecs.map(invokeArgs(["pre"], [])));
    const newElement = yield visitAsync(element, mergedPluginsVisitor, visitorOptions);
    yield Promise.allSettled(pluginsSpecs.map(invokeArgs(["post"], [])));
    return newElement;
  });
  dispatchPluginsSync[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")] = dispatchPluginsAsync;

  var shortUniqueId = {exports: {}};

  var hasRequiredShortUniqueId;

  function requireShortUniqueId () {
  	if (hasRequiredShortUniqueId) return shortUniqueId.exports;
  	hasRequiredShortUniqueId = 1;
  	(function (module) {
  		var ShortUniqueId = (() => {
  	...
  	return shortUniqueId.exports;
  }

  var shortUniqueIdExports = requireShortUniqueId();
  ...
  var __publicField$a = (obj, key, value) => __defNormalProp$d(obj, typeof key !== "symbol" ? key + "" : key, value);
  class IdentityManager {
    constructor({ length = 6 } = {}) {
      __publicField$a(this, "uuid");
      __publicField$a(this, "identityMap");
    ...
    identify(element) {
      ...
      const id = new minimExports.StringElement(this.generateId());
  ...
  const plugin = ({ length = 6 } = {}) => ({ predicates }) => {
    let identityManager;
    return {
      pre() {
        identityManager = new IdentityManager({ length });
  ...
  class MediaTypes extends Array {
    constructor() {
      super(...arguments);
      __publicField$9(this, "unknownMediaType", "application/octet-stream");
    }
  ...
  const filter = (predicate, element) => {
    ...
    visit$1(element, visitor);
    return new minimExports.ArraySlice(visitor.result);
  };

  const find = (predicate, element) => {
    const visitor = new PredicateVisitor({ predicate, returnOnTrue: BREAK });
    visit$1(element, visitor);
    return pathOr(void 0, [0], visitor.result);
  };
  ...
  let Visitor$2 = class Visitor {
    constructor({ offset = 0, includeRightBound = false } = {}) {
      __publicField$8(this, "result");
      __publicField$8(this, "offset");
      __publicField$8(this, "includeRightBound");
      this.result = [];
      this.offset = offset;
  ...
  const findAtOffset = (options, element) => {
    ...
    const visitor = new Visitor$2({ offset, includeRightBound });
    visit$1(element, visitor);
  ...
  class CallbackVisitor extends PredicateVisitor {
    constructor(_a = {}) {
      var _b = _a, { callback = noop } = _b, rest = __objRest$1(_b, ["callback"]);
      super(__spreadValues$3({}, rest));
      __publicField$7(this, "callback");
  ...
  let Visitor$1 = class Visitor {
    constructor() {
      __publicField$6(this, "parentEdges");
      __publicField$6(this, "parent");
      this.parentEdges = /* @__PURE__ */ new WeakMap();
    }
  ...
  class Transcluder {
    ...
    transclude(search, replace) {
      ...
      this.edges = (_a = this.edges) != null ? _a : computeEdges(this.element);
  ...
  const fromFn = (data, namespace$1 = namespace) => {
    if (isString(data)) {
      try {
        return namespace$1.fromRefract(JSON.parse(data));
      } catch (e) {
      }
    }
    if (isPlainObj(data) && has("element", data)) {
      return namespace$1.fromRefract(data);
    }
    return namespace$1.toElement(data);
  };
  ...
  const keyMapDefault = __spreadValues$2({
    EphemeralObject: ["content"],
    EphemeralArray: ["content"]
  }, keyMapDefault$1);
  const visit = (root, visitor2, _a = {}) => {
    var _b = _a, { keyMap = keyMapDefault } = _b, rest = __objRest(_b, ["keyMap"]);
    return visit$1(root, visitor2, __spreadValues$2({
      keyMap,
      // @ts-ignore
      nodeTypeGetter,
      nodePredicate: T,
      detectCycles: false,
      deleteNodeSymbol: /* @__PURE__ */ Symbol.for("delete-node"),
      skipVisitingNodeSymbol: /* @__PURE__ */ Symbol.for("skip-visiting-node")
    }, rest));
  };
  visit[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")] = (_0, ..._1) => __async(null, [_0, ..._1], function* (root, _c = {}) {
    var _d = _c, { keyMap = keyMapDefault } = _d, rest = __objRest(_d, ["keyMap"]);
    return visit$1[/* @__PURE__ */ Symbol.for("nodejs.util.promisify.custom")](root, visitor, __spreadValues$2({
      keyMap,
      nodeTypeGetter,
      nodePredicate: T,
      detectCycles: false,
  ...
  class EphemeralArray {
    constructor(content) {
      __publicField$4(this, "type", "EphemeralArray");
      __publicField$4(this, "content", []);
      __publicField$4(this, "reference");
      this.content = content;
      this.reference = [];
    }
    toReference() {
  ...
  class EphemeralObject {
    constructor(content) {
      __publicField$3(this, "type", "EphemeralObject");
      __publicField$3(this, "content", []);
      __publicField$3(this, "reference");
      this.content = content;
      this.reference = {};
    }
    toReference() {
  ...
  class Visitor {
    constructor() {
      __publicField$2(this, "ObjectElement", {
        enter: (element) => {
      ...
      __publicField$2(this, "EphemeralObject", {
        leave: (ephemeral) => {
          return ephemeral.toObject();
        }
      });
      __publicField$2(this, "MemberElement", {
        enter: (element) => {
          return [element.key, element.value];
        }
      });
      __publicField$2(this, "ArrayElement", {
        enter: (element) => {
          if (this.references.has(element)) {
            return this.references.get(element).toReference();
          }
      ...
      __publicField$2(this, "EphemeralArray", {
        leave: (ephemeral) => {
          return ephemeral.toArray();
        }
      });
      __publicField$2(this, "references", /* @__PURE__ */ new WeakMap());
    }
    ...
    RefElement(element, ...rest) {
      ...
      if (((_a = ancestors[ancestors.length - 1]) == null ? void 0 : _a.type) === "EphemeralObject") {
        return /* @__PURE__ */ Symbol.for("delete-node");
      }
  ...
  const serializer$1 = (element, replacer, space) => JSON.stringify(serializer$2(element), replacer, space);

  var __defProp$3 = Object.defineProperty;
  var __defNormalProp$3 = (obj, key, value) => key in obj ? __defProp$3(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
  var __publicField$1 = (obj, key, value) => __defNormalProp$3(obj, typeof key !== "symbol" ? key + "" : key, value);
  const _YamlVisitor = class _YamlVisitor {
    constructor({ directive = false, indent = 0 } = {}) {
      __publicField$1(this, "result");
      __publicField$1(this, "indent");
      this.result = directive ? "%YAML 1.2\n---\n" : "";
      this.indent = indent;
    }
    NumberElement(element) {
      this.result += serializer$2(element);
    }
    BooleanElement(element) {
      const value = serializer$2(element);
      this.result += value ? "true" : "false";
    }
    StringElement(element) {
      this.result += JSON.stringify(serializer$2(element));
    }
    NullElement() {
      this.result += "null";
    }
    ArrayElement(element) {
      ...
      element.forEach((item) => {
        const visitor = new _YamlVisitor({ indent: this.indent + 1 });
        const indent = _YamlVisitor.indentChar.repeat(this.indent);
        visit$1(item, visitor);
...
${indent}- ${result}`;
    ...
    ObjectElement(element) {
      ...
      element.forEach((value, key) => {
        const keyVisitor = new _YamlVisitor({ indent: this.indent + 1 });
        const valueVisitor = new _YamlVisitor({ indent: this.indent + 1 });
        const indent = _YamlVisitor.indentChar.repeat(this.indent);
        visit$1(key, keyVisitor);
        visit$1(value, valueVisitor);
...
${indent}${keyResult}: ${valueResult}`;
  ...
  __publicField$1(_YamlVisitor, "indentChar", "  ");
  let YamlVisitor = _YamlVisitor;
  const serializer = (element, { directive = false } = {}) => {
    const visitor = new YamlVisitor({ directive });
    visit$1(element, visitor);
    return visitor.result;
  };

  const dehydrate = (element, namespace$1 = namespace) => {
    return namespace$1.toRefract(element);
  };

  const toString = (element, namespace$1 = namespace) => {
    const refractStructure = dehydrate(element, namespace$1);
  ...
  class SymbolicExpressionsVisitor {
    constructor() {
      ...
      __publicField(this, "nestingLevel", 0);
    }
    enter(element) {
  ...
  const cloneUnlessOtherwiseSpecified = (element, options) => options.clone && options.isMergeableElement(element) ? deepmerge(
  ...
  const mergeObjectElement = (targetElement, sourceElement, options) => {
    ...
    sourceElement.forEach((value, key, member) => {
      const keyValue = serializer$2(key);
      let clonedMember;
  ...
  const deepmerge = (targetElement, sourceElement, options) => {
    var _a, _b, _c;
    const mergedOptions = __spreadValues$1(__spreadValues$1({}, defaultOptions), options);
    mergedOptions.isMergeableElement = (_a = mergedOptions.isMergeableElement) != null ? _a : defaultOptions.isMergeableElement;
    mergedOptions.arrayElementMerge = (_b = mergedOptions.arrayElementMerge) != null ? _b : defaultOptions.arrayElementMerge;
    mergedOptions.objectElementMerge = (_c = mergedOptions.objectElementMerge) != null ? _c : defaultOptions.objectElementMerge;
    ...
    const mergedElement = sourceIsArrayElement && typeof mergedOptions.arrayElementMerge === "function" ? mergedOptions.arrayElementMerge(
      targetElement,
      sourceElement,
      mergedOptions
  ...
  exports.AnnotationElement = Annotation;
  exports.ArrayElement = minimExports.ArrayElement;
  exports.ArraySlice = minimExports.ArraySlice;
  exports.BREAK = BREAK;
  exports.BooleanElement = minimExports.BooleanElement;
  exports.CloneError = CloneError;
  exports.CommentElement = Comment;
  exports.DeepCloneError = DeepCloneError;
  exports.Element = minimExports.Element;
  exports.ElementIdentityError = ElementIdentityError;
  exports.IdentityManager = IdentityManager;
  exports.KeyValuePair = minimExports.KeyValuePair;
  exports.LinkElement = minimExports.LinkElement;
  exports.MediaTypes = MediaTypes;
  exports.MemberElement = minimExports.MemberElement;
  exports.Namespace = Namespace;
  exports.NullElement = minimExports.NullElement;
  exports.NumberElement = minimExports.NumberElement;
  exports.ObjectElement = minimExports.ObjectElement;
  exports.ObjectSlice = minimExports.ObjectSlice;
  exports.ParseResultElement = ParseResult;
  exports.RefElement = minimExports.RefElement;
  exports.ShallowCloneError = ShallowCloneError;
  exports.StringElement = minimExports.StringElement;
  exports.Transcluder = Transcluder;
  ...
  exports.defaultIdentityManager = defaultIdentityManager;
  exports.dehydrate = dehydrate;
  exports.dereference = dereference;
  exports.dispatchRefractorPlugins = dispatchPluginsSync;
  exports.filter = filter;
  exports.find = find;
  exports.findAtOffset = findAtOffset;
  exports.from = fromFn;
  ...
  exports.keyMap = keyMapDefault$1;
  exports.mergeAllVisitors = mergeAll;
  exports.mergeLeft = mergeLeft;
  exports.mergeRight = mergeRight;
  exports.namespace = namespace;
  exports.parents = parents;
  exports.refract = minimExports.refract;
  exports.refractorPluginElementIdentity = plugin$1;
  exports.refractorPluginSemanticElementIdentity = plugin;
  exports.reject = reject;
  exports.sexprs = sexprs;
  exports.some = some;
  exports.toJSON = serializer$1;
  exports.toString = toString;
  exports.toValue = serializer$2;
  exports.toYAML = serializer;
